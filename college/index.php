      ...
      <div class="examLayout layout ">
        ...
        <aside class="examFilters" id="examFiltersPanel">
          ...
          <!-- <div class="examFilterGroup">
                ...
                <label class="examCheck"><input type="checkbox"
                    value="Ahmedabad"
                    data-filter-group="city"><span>Ahmedabad</span><em></em></label>
                <label class="examCheck"><input type="checkbox"
                    value="Bengaluru"
                    data-filter-group="city"><span>Bengaluru</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Bhopal"
                    data-filter-group="city"><span>Bhopal</span><em></em></label>
                <label class="examCheck"><input type="checkbox"
                    value="Bhubaneswar"
                    data-filter-group="city"><span>Bhubaneswar</span><em></em></label>
                <label class="examCheck"><input type="checkbox"
                    value="Chandigarh"
                    data-filter-group="city"><span>Chandigarh</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Chennai"
                    data-filter-group="city"><span>Chennai</span><em></em></label>
                <label class="examCheck"><input type="checkbox"
                    value="Coimbatore"
                    data-filter-group="city"><span>Coimbatore</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Dehradun"
                    data-filter-group="city"><span>Dehradun</span><em></em></label>
                <div class="examFilterGroup__extra" id="examCityExtra" hidden>
                  <label class="examCheck"><input type="checkbox"
                      value="Delhi NCR"
                      data-filter-group="city"><span>Delhi
                      NCR</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Ghaziabad"
                      data-filter-group="city"><span>Ghaziabad</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Greater Noida"
                      data-filter-group="city"><span>Greater
                      Noida</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Gurugram"
                      data-filter-group="city"><span>Gurugram</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Guwahati"
                      data-filter-group="city"><span>Guwahati</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Hyderabad"
                      data-filter-group="city"><span>Hyderabad</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Indore"
                      data-filter-group="city"><span>Indore</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Jaipur"
                      data-filter-group="city"><span>Jaipur</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Jalandhar"
                      data-filter-group="city"><span>Jalandhar</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Jammu"
                      data-filter-group="city"><span>Jammu</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Jamshedpur"
                      data-filter-group="city"><span>Jamshedpur</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Kanpur"
                      data-filter-group="city"><span>Kanpur</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Kochi"
                      data-filter-group="city"><span>Kochi</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Kolkata"
                      data-filter-group="city"><span>Kolkata</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Kozhikode"
                      data-filter-group="city"><span>Kozhikode</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Lucknow"
                      data-filter-group="city"><span>Lucknow</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Ludhiana"
                      data-filter-group="city"><span>Ludhiana</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Mumbai"
                      data-filter-group="city"><span>Mumbai</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Mysuru"
                      data-filter-group="city"><span>Mysuru</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Nagpur"
                      data-filter-group="city"><span>Nagpur</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Nashik"
                      data-filter-group="city"><span>Nashik</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Noida"
                      data-filter-group="city"><span>Noida</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Patna"
                      data-filter-group="city"><span>Patna</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Pune"
                      data-filter-group="city"><span>Pune</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Raipur"
                      data-filter-group="city"><span>Raipur</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Ranchi"
                      data-filter-group="city"><span>Ranchi</span><em></em></label>
                  <label class="examCheck"><input type="checkbox" value="Surat"
                      data-filter-group="city"><span>Surat</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Tiruchirappalli"
                      data-filter-group="city"><span>Tiruchirappalli</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Vadodara"
                      data-filter-group="city"><span>Vadodara</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Varanasi"
                      data-filter-group="city"><span>Varanasi</span><em></em></label>
                  <label class="examCheck"><input type="checkbox"
                      value="Visakhapatnam"
                      data-filter-group="city"><span>Visakhapatnam</span><em></em></label>
                </div>
                <button class="examFilterGroup__more" id="examCityMoreBtn">+
                  Show
                  more</button>
              </div> -->
          ...
          <!-- <div class="examFilterGroup">
                ...
                <div class="examFeeRange__labels"><span>₹3 lakhs</span><span
          ...
          <!-- <div class="examFilterGroup">
                ...
                <label class="examCheck"><input type="checkbox"
                    value="24-30 LPA" data-filter-group="package"><span>24-30
                    LPA</span><em>6</em></label>
                <label class="examCheck"><input type="checkbox"
                    value="30-40 LPA" data-filter-group="package"><span>30-40
                    LPA</span><em>4</em></label>
                <label class="examCheck"><input type="checkbox"
                    value="40-50 LPA" data-filter-group="package"><span>40-50
                    LPA</span><em>5</em></label>
                <label class="examCheck"><input type="checkbox"
                    value="32-40 LPA" data-filter-group="package"><span>32-40
                    LPA</span><em>3</em></label>
                <label class="examCheck"><input type="checkbox"
                    value="Below 5 LPA" data-filter-group="package"><span>Below
                    5 LPA</span><em>12</em></label>
              </div>

              <div class="examFilterGroup">
                <p class="examFilterGroup__title">NIRF Ranking</p>
                <label class="examCheck"><input type="checkbox" value="Top 10"
                    data-filter-group="nirf"><span>Top
                    10</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Top 25"
                    data-filter-group="nirf"><span>Top
                    25</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Top 50"
                    data-filter-group="nirf"><span>Top
                    50</span><em></em></label>
                <label class="examCheck"><input type="checkbox" value="Top 100"
                    data-filter-group="nirf"><span>Top
