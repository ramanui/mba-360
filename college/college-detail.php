      ...
      <section class="clg-header">
        ...
        <div class="container">
          <nav class="clg-breadcrumb" aria-label="Breadcrumb">
            ...
            <span aria-current="page">SPJIMR</span>
          </nav>
          <div class="clg-heroTop-wrap">
              ...
              <div class="clg-heroMain">
                <div class="fg-div">
                  <div class="clg-logoCard">
                    <img
                      src="../src/assets/images/spjmir.webp"
                      width="64" height="64"
                      alt="SPJIMR logo"
                      loading="eager"
                      fetchpriority="high"
                ...
                <div class="clg-titleBlock">
                  <h1 class="clg-title">SPJIMR Mumbai: Admission 2026, Cutoff,
                    Courses</h1>
                  <p class="clg-metaRow">
            ...
            <div class="alumniCard__media">
              <img src="../src/assets/images/slide-1.webp" width="396" height="224"
        ...
        <div class="container clg-main">
          <div class="clg-layout">
            ...
            <div class="clg-content">
              ...
              <section id="overview" class="clg-section"
                ...
                <div class="clg-card clg-about" data-open="false"
                  ...
                  <h2 id="overview-heading"
                    class="clg-section__title pl-0 ">About SPJIMR</h2>
                  <div class="clg-about__body">

                    <div class="clg-about__intro">
                      <p>
                        SPJIMR is one of India's leading management institutes,
                        known for its rigorous
                        academics, industry-linked curriculum and a strong focus
                        on values-based leadership.
                        Since 1961 the institute has built a reputation for
                        producing socially conscious,
                        globally competent managers across its full-time and
                        executive programmes.
                      </p>
                      <p>The institute is consistently ranked among the top
                        private business schools in the country and holds
                        international accreditations from EQUIS, AACSB and
                        AMBA.</p>
                      <p>
                        SPJIMR is one of India's leading management institutes,
                        known for its rigorous
                  ...
                  <div class="clg-about__more" id="about-more">
                    <div>
                      <div class="clg-about__body">
                        <p>Its Post Graduate Diploma in Management (PGDM) blends
                          classroom rigour with immersive, practice-focused
                          learning, while the institute's alumni network of
                          38,000+ spans leadership roles across industries
                          worldwide. SPJIMR's 103-acre campus and low 7:1
                          student-to-faculty ratio support close mentorship
                          throughout the programme.</p>
                        <p>Beyond the flagship PGDM, the institute runs
                          doctoral, family business, entrepreneurship and
                          executive education tracks, reflecting its broader
                          mission of shaping responsible, enterprising leaders
              ...
              <section id="ranking" class="clg-section ranking reveal"
                aria-labelledby="ranking-heading">
                <h2 id="ranking-heading" class="clg-section__title">Rankings
                  &amp; Accreditations</h2>
                <hr>
                <div class="clg-card">
                  <h3 class="clg-subheading">Rankings</h3>
                  <div class="clg-rankGrid">
                    <div class="clg-rankItem">
                      <p class="clg-rankItem__num">#3</p>
                      <span class="clg-rankItem__label">in India</span>
                      <p class="clg-rankItem__source">FT Masters in Management
                        2025 Ranking</p>
                    </div>
                    <div class="clg-rankItem">
                      <p class="clg-rankItem__num">#35</p>
                      <span class="clg-rankItem__label">In the World</span>
                      <p class="clg-rankItem__source">FT Masters in Management
                        2025 Ranking</p>
                    </div>
                    <div class="clg-rankItem">
                      <p class="clg-rankItem__num">#1</p>
                      <span class="clg-rankItem__label">All India Private
                        B-School Rank</span>
                      <p class="clg-rankItem__source">BT-MDRA India's Best
                        B-Schools Ranking 2025</p>
                    </div>
                    <div class="clg-rankItem">
                      <p class="clg-rankItem__num">#1</p>
                      <span class="clg-rankItem__label">All India Private
                        B-school</span>
                      <p class="clg-rankItem__source">India Today Group MDRA
                        Best Business Schools Survey 2025</p>
                    </div>
                  </div>

                  <h3 class="clg-subheading">Accreditations</h3>
                  <ul class="clg-accredRow">
                    <li class="clg-accredLogo"><img
                        src="../src/assets/images/equis.webp" width="90"
                        height="30" alt="EQUIS accredited" loading="lazy"
                        decoding="async" /></li>
                    <li class="clg-accredLogo"><img
                        src="../src/assets/images/equis.webp" width="90"
                        height="30" alt="AACSB accredited" loading="lazy"
                        decoding="async" /></li>
                    <li class="clg-accredLogo"><img
                        src="../src/assets/images/equis.webp" width="90"
                        height="30" alt="AMBA accredited" loading="lazy"
                        decoding="async" /></li>
                    <li class="clg-accredLogo"><img
                        src="../src/assets/images/equis.webp" width="90"
                        height="30" alt="NBA accredited" loading="lazy"
                        decoding="async" /></li>
                    <li class="clg-accredLogo"><img
                        src="../src/assets/images/equis.webp" width="90"
                        height="30"
                        alt="Association of Indian Universities member"
              ...
              <section id="programmes" class="clg-section reveal"
                ...
                <div class="clg-card">
                  ...
                  <div class="clg-pillTabs" role="tablist" data-tablist
                    ...
                    <button role="tab" id="pill-pg"
                      aria-controls="pill-pg-panel" aria-selected="true"
                      type="button">Post Graduate</button>
                    <button role="tab" id="pill-doc"
                      aria-controls="pill-doc-panel" aria-selected="false"
                      type="button">Doctoral</button>
                    <button role="tab" id="pill-online"
                      aria-controls="pill-online-panel" aria-selected="false"
                      type="button">Online Education</button>
                    <button role="tab" id="pill-fb"
                      aria-controls="pill-fb-panel" aria-selected="false"
                      type="button">Family Business</button>
                    <button role="tab" id="pill-ent"
                      aria-controls="pill-ent-panel" aria-selected="false"
                      type="button">Entrepreneurship</button>
                    <button role="tab" id="pill-exec"
                      aria-controls="pill-exec-panel" aria-selected="false"
                      type="button">Executive Education</button>
                  </div>
                  ...
                  <div id="pill-pg-panel" role="tabpanel"
                    ...
                    <div class="clg-accordion">
                      ...
                      <div class="clg-accItem" data-open="true" id="acc-pgdma">
                        <h3 style="margin:0;">
                          <button class="clg-accHeader" type="button"
                            data-toggle-target="acc-pgdma" aria-expanded="true"
                            aria-controls="acc-pgdma">
                        ...
                        <div class="clg-accPanel"><div
                            ...
                            <div class="clg-progTabs" role="tablist"
                              data-tablist aria-label="PGDM details">
                              <button role="tab" id="pt-overview"
                                aria-controls="pt-overview-panel"
                                aria-selected="true"
                                type="button">Overview</button>
                              <button role="tab" id="pt-eligibility"
                                aria-controls="pt-eligibility-panel"
                                aria-selected="false" type="button">Eligibility
                                &amp; Admission</button>
                              <button role="tab" id="pt-fees"
                                aria-controls="pt-fees-panel"
                                aria-selected="false" type="button">Fees &amp;
                                Scholarships</button>
                              <button role="tab" id="pt-timeline"
                                aria-controls="pt-timeline-panel"
                                aria-selected="false" type="button">Admission
                                Timeline</button>
                              <button role="tab" id="pt-faqs"
                                aria-controls="pt-faqs-panel"
                                aria-selected="false"
                                type="button">FAQs</button>
                            </div>

                            <div id="pt-overview-panel" role="tabpanel"
                              aria-labelledby="pt-overview">
                              <dl class="clg-factGrid">
                                <div class="clg-factBox"><dt>Duration</dt><dd>2
                                    Years</dd></div>
                                <div class="clg-factBox"><dt>Programme
                                    Starts</dt><dd>June 2027</dd></div>
                                <div
                                  class="clg-factBox"><dt>Fees</dt><dd>₹24,86,000</dd></div>
                              </dl>
                              <p>SPJIMR's Post Graduate Diploma in Management
                                (PGDM) is a two-year, full-time residential
                                programme equivalent to an MBA. PGDM is approved
                                by AICTE, accredited by NBA and AMBA UK, and
                                consistently rates among India's top 10
                                management programmes. The programme offers a
                                holistic approach to leadership development
                                through a blend of classroom learning and
                                curated immersive experiences, guided by
                                SPJIMR's faculty of accomplished academicians
                                and practitioners.</p>
                              <p>In the Financial Times Masters in Management
                                (FT MiM) 2025 Ranking, SPJIMR was ranked 35th
                                globally and 3rd in India. The institute secured
                                3rd place worldwide — and 1st in India — in the
                                "Careers Service" category, and was also ranked
                                #1 among Indian B-schools in Alumni Network,
                                Value for Money, and ESG &amp; Net Zero Teaching
                                for its PGDM programme.</p>
                            </div>
                            <div id="pt-eligibility-panel" role="tabpanel"
                              aria-labelledby="pt-eligibility" hidden>
                              <p>Bachelor's degree in any discipline with a
                                minimum aggregate of 50%, along with a valid CAT
                                / GMAT / XAT score. Shortlisted candidates go
                                through a written ability test and a personal
                                interview round.</p>
                            </div>
                            <div id="pt-fees-panel" role="tabpanel"
                              aria-labelledby="pt-fees" hidden>
                              <p>Total programme fee is ₹24,86,000, payable in
                                instalments. Need- and merit-based scholarships
                                are available for eligible candidates, including
                                special scholarships for women applicants.</p>
                            </div>
                            <div id="pt-timeline-panel" role="tabpanel"
                              aria-labelledby="pt-timeline" hidden>
                              <p>Applications open in August, with a final
                                submission deadline of November 30, 2025.
                                Interviews are conducted between February and
                                March, and the final admit list is released by
                                April.</p>
                            </div>
                            <div id="pt-faqs-panel" role="tabpanel"
                              aria-labelledby="pt-faqs" hidden>
                              <p>Common questions cover work-experience
                                requirements, scholarship eligibility and hostel
                                accommodation — reach out to admissions for a
                                full FAQ list.</p>
                            </div>
                      ...
                      <div class="clg-accItem" data-open="false"
                        ...
                        <h3 style="margin:0;">
                          <button class="clg-accHeader" type="button"
                            data-toggle-target="acc-pgdmbmb"
                            aria-expanded="false" aria-controls="acc-pgdmbmb">
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                src="../src/assets/images/book.webp" width="30"
                                height="30"
                      ...
                      <div class="clg-accItem" data-open="false" id="acc-pgpmc">
                        <h3 style="margin:0;">
                          <button class="clg-accHeader" type="button"
                            data-toggle-target="acc-pgpmc" aria-expanded="false"
                            aria-controls="acc-pgpmc">
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                src="../src/assets/images/book.webp" width="30"
                                height="30"
                      ...
                      <div class="clg-accItem" data-open="false" id="acc-gmpd">
                        <h3 style="margin:0;">
                          <button class="clg-accHeader" type="button"
                            data-toggle-target="acc-gmpd" aria-expanded="false"
                            aria-controls="acc-gmpd">
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                src="../src/assets/images/book.webp" width="30"
                                height="30"
                      ...
                      <div class="clg-accItem" data-open="false"
                        ...
                        <h3 style="margin:0;">
                          <button class="clg-accHeader" type="button"
                            data-toggle-target="acc-pgempe"
                            aria-expanded="false" aria-controls="acc-pgempe">
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                src="../src/assets/images/book.webp" width="30"
                                height="30"
                  ...
                  <div id="pill-doc-panel" role="tabpanel"
                    aria-labelledby="pill-doc" class="is-active">
                    <div class="clg-accordion">
                      ...
                      <div class="clg-accItem" data-open="true" id="acc-pgdm">
                          ...
                          <button class="clg-accHeader" type="button"
                            ...
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                ...
                                alt="Post Graduate Diploma in Management"
                                loading="lazy" decoding="async" /></span>
                            <span class="clg-accHeader__title">22222Post
                              Graduate Diploma in Management (PGDM)</span>
                            <span class="clg-accHeader__toggle"
                              aria-hidden="true">–</span>
                          </button>
                        </h3>
                        <div class="clg-accPanel"><div
                            ...
                            <div class="clg-progTabs" role="tablist"
                              data-tablist aria-label="PGDM details">
                              <button role="tab" id="pt-overview1"
                                aria-controls="pt-overview-panel1"
                                aria-selected="true"
                                type="button">Overview</button>
                              <button role="tab" id="pt-eligibility1"
                                aria-controls="pt-eligibility-panel1"
                                aria-selected="false" type="button">Eligibility
                                &amp; Admission</button>
                              <button role="tab" id="pt-fees1"
                                aria-controls="pt-fees-panel1"
                                aria-selected="false" type="button">Fees &amp;
                                Scholarships</button>
                              <button role="tab" id="pt-timeline1"
                                aria-controls="pt-timeline-panel1"
                                aria-selected="false" type="button">Admission
                                Timeline</button>
                              <button role="tab" id="pt-faqs1"
                                aria-controls="pt-faqs-panel1"
                                aria-selected="false"
                                type="button">FAQs</button>
                            </div>

                            <div id="pt-overview-panel1" role="tabpanel"
                              aria-labelledby="pt-overview1">
                              <dl class="clg-factGrid">
                                <div class="clg-factBox"><dt>Duration</dt><dd>2
                                    Years</dd></div>
                                <div class="clg-factBox"><dt>Programme
                            ...
                            <div id="pt-eligibility-panel1" role="tabpanel"
                              aria-labelledby="pt-eligibility1" hidden>
                              <p>Bachelor's degree in any discipline with a
                                minimum aggregate of 50%, along with a valid CAT
                                / GMAT / XAT score. Shortlisted candidates go
                                through a written ability test and a personal
                            ...
                            <div id="pt-fees-panel1" role="tabpanel"
                              aria-labelledby="pt-fees1" hidden>
                              <p>Total programme fee is ₹24,86,000, payable in
                                instalments. Need- and merit-based scholarships
                                are available for eligible candidates, including
                                special scholarships for women applicants.</p>
                            </div>
                            <div id="pt-timeline-panel1" role="tabpanel"
                              aria-labelledby="pt-timeline1" hidden>
                              <p>Applications open in August, with a final
                                submission deadline of November 30, 2025.
                                Interviews are conducted between February and
                                March, and the final admit list is released by
                            ...
                            <div id="pt-faqs-panel1" role="tabpanel"
                              aria-labelledby="pt-faqs1" hidden>
                              <p>Common questions cover work-experience
                                requirements, scholarship eligibility and hostel
                                accommodation — reach out to admissions for a
                                full FAQ list.</p>
              ...
              <section id="dates" class="clg-section reveal"
                ...
                <div class=" clg-card clg-tableWrap">
                  <table class="clg-table">
                    ...
                    <tbody>
                      <tr>
                        <th scope="row">Post Graduate Diploma in Management
                          (PGDM)</th>
                      ...
                      <tr>
                        <th scope="row">Post Graduate Diploma in Management
                          Business Management PGDM (BM)</th>
                        <td><span class="clg-dateCell"><img
                              src="../src/assets/images/calendar-icon.webp"
                              width="26" height="26"
                      ...
                      <tr>
                        <th scope="row">Post Graduate Programme in Management
                          (PGPM)</th>
                        <td><span class="clg-dateCell"><img
                              src="../src/assets/images/calendar-icon.webp"
                              width="26" height="26"
                      ...
                      <tr>
                        <th scope="row">Global Management Programme (GMP)</th>
                        <td><span class="clg-dateCell"><img
                              src="../src/assets/images/calendar-icon.webp"
                              width="26" height="26"
                          ...
                          <button class="clg-accHeader" type="button"
                            ...
                            <span class="clg-accHeader__icon"
                              aria-hidden="true"><img
                                ...
                                loading="lazy" decoding="async" /></span>
                            <span class="clg-accHeader__title">Post Graduate
                              Diploma in Management (PGDM)sss</span>
                            <span class="clg-accHeader__toggle"
                              aria-hidden="true">–</span>
                          </button>
                        </h3>
          ...
          Complete guides for all management entrance exams.
            ...
            <aside class="clg-aside" aria-label="Quick facts and links">
              ...
              <div class="clg-ctaCard reveal" id="enquire">
                <h2>Ready to Apply to SPJIMR?</h2>
              ...
              <div class="clg-card clg-sideCard">
                ...
                <dl class="clg-factsList">
                  ...
                  <div><dt>Institute Type</dt><dd>Private</dd></div>
                  <div><dt>Campus Area</dt><dd>103 Acres</dd></div>
                  <div><dt>Total Faculty</dt><dd>108 Full-time</dd></div>
                  <div><dt>Student:Faculty</dt><dd>7:1</dd></div>
                  <div><dt>Total Students</dt><dd>~2,100</dd></div>
                  <div><dt>Alumni Network</dt><dd>38,000+</dd></div>
                  <div><dt>Official Website</dt><dd><a
                        href="https://www.spjimr.org"
                        rel="noopener">spjimr.org</a></dd></div>
                </dl>
              </div>
