<?php
// Shared site header. Include with: require __DIR__ . '/includes/header.php';  (root pages)
//                              or: require __DIR__ . '/../includes/header.php'; (one level down)
// This file works out the correct relative prefix itself -- no $base variable
// needs to be set by the page that includes it, and no assumption is made
// about the server's current working directory (which can differ between
// local dev servers and live hosting -- that mismatch is what breaks include
// paths when only plain relative paths or a manually-set variable are used).
...
?>
<script>window.SITE_BASE = "<?php echo $__base; ?>";</script>
    ...
    ====================================================== -->
        ...
        ================================================== -->
            ...
            <!-- <li class="site-nav__item--mega">
                                        ...
                                        <div class="mega-menu" id="megaExec">
                                                ...
                                                <div
                                                        ...
                                                        <div
                                                                ...
                                                                <div
                                                                        class="mega-menu__featured-top">
                                                                        <p
                                                                                class="mega-menu__title">Executive
                                                                                MBA</p>
                                                                </div>
